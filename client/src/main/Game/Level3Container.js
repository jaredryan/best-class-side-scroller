...
class Level3Container extends Component {
    ...
    resetLevel() {
        this.setState({
            ...
            wave4: [
                {height: 29, width: 50, left: 530, top: 35, health: 5, type: "ufo"},
                {height: 29, width: 50, left: 530, top: 155, health: 5, type: "ufo"},
                {height: 29, width: 50, left: 530, top: 275, health: 5, type: "ufo"},
                {height: 50, width: 35, left: 530, top: 295, health: 5, type: "girl"},
                {height: 50, width: 34, left: 530, top: 15, health: 5, type: "ironman"}
            ]
        });
    }
