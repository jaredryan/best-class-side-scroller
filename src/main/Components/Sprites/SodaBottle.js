...
const SodaBottle = () => (
  ...
  >
    ...
    <circle className="sodaBubble sodaBubbleA" cx="88" cy="12" r="5" fill="#ffffff" opacity="0.85" />
    <circle className="sodaBubble sodaBubbleB" cx="98" cy="24" r="4" fill="#ffffff" opacity="0.7" />
    <circle className="sodaBubble sodaBubbleC" cx="92" cy="58" r="4" fill="#ffffff" opacity="0.7" />
  </svg>
);
